          ...
          <div className="bg-gray-800 rounded-lg p-6 mb-8 border border-gray-600">
            ...
            <div className="flex space-x-1 bg-gray-700 p-1 rounded-lg">
              ...
              <button
                ...
                className={`flex-1 py-3 px-6 rounded-md text-sm font-medium transition-colors relative ${
                  activeTab === 'received'
                    ? 'bg-blue-600 text-white'
                    : 'text-gray-300 hover:text-white hover:bg-gray-600'
                }`}
                  ...
                  <div>
                    {friendsData.friends.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-500 mb-4">Find other players and send them friend requests!</p>
                        <button
                          onClick={() => setActiveTab('search')}
                      ...
                      <div className="space-y-4">
                        {friendsData.friends.map((friend) => (
                          <div key={friend.id} className="flex items-center justify-between p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors border border-gray-500">
                            <div className="flex items-center space-x-4">
                              <div className="relative">
                                ...
                                <div className={`absolute bottom-0 right-0 w-4 h-4 rounded-full border-2 border-gray-700 ${
                  ...
                  <div>
                    {friendsData.receivedRequests.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-500 mt-2">Friend requests will appear here when other players send them to you</p>
                      </div>
                    ) : (
                      <div className="space-y-4">
                        {friendsData.receivedRequests.map((request) => (
                          <div key={request.id} className="flex items-center justify-between p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors border border-gray-500">
                            <div className="flex items-center space-x-4">
                              <div className="relative">
                                {request.sender.avatar ? (
                                  <img src={request.sender.avatar} alt={request.sender.username} className="w-12 h-12 rounded-full" />
                                ) : (
                                  <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold">
                  ...
                  <div>
                    {friendsData.sentRequests.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-500 mt-2">Friend requests you send will appear here</p>
                      </div>
                    ) : (
                      <div className="space-y-4">
                            ...
                            <div className="flex items-center space-x-4">
                              <div className="relative">
                                {request.receiver.avatar ? (
                                  <img src={request.receiver.avatar} alt={request.receiver.username} className="w-12 h-12 rounded-full" />
                                ) : (
                                  <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold">
                ...
                {activeTab === 'search' && (
                  <div>
                    {searchLoading ? (
                      ...
                      <div className="text-center py-8">
                        <p className="text-gray-400 text-lg">Enter at least 2 characters to search for players</p>
                        <p className="text-gray-500 mt-2">Use the search box above to find other players</p>
                      </div>
                    ) : searchResults.length === 0 ? (
                      <div className="text-center py-8">
                        <p className="text-gray-400 text-lg">No players found with username "{searchQuery}"</p>
                        <p className="text-gray-500 mt-2">Try a different search term</p>
                      </div>
                    ) : (
                      <div className="space-y-4">
                        {searchResults.map((user) => (
                          <div key={user.id} className="flex items-center justify-between p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors border border-gray-500">
                            <div className="flex items-center space-x-4">
                              <div className="relative">
                                {user.avatar ? (
                            ...
                            <div>
                              ...
                              {user.friendshipStatus === 'request_received' && (
                                <div className="flex space-x-2">
                                  ...
                                  <button
                                    onClick={() => user.friendshipId && declineFriendRequest(user.friendshipId)}
